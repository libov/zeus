      real function tlidca(par1,par2)
******************************************************************************
...
*-----------------------------------------------------------------------------
* $Source: /afs/desy.de/user/s/stadie/zeus/cvsroot/tlite/src/dca/tlidca.fpp,v $
* $Revision: 1.1 $
...
*        **** test distance
         call rmhelix(par1,phi1,v1)
         call rmhelix(par2,phi2,v2)
         dd = (v2(1)-v1(1))**2
     +        + (v2(2)-v1(2))**2
     +        + (v2(3)-v1(3))**2
#ifdef VERBOSE
         print *,' tlidca: iter ',iter,' distance ',sqrt(dd)
#endif
         tlidca = sqrt(dd)
...
*               **** stop if repeatedly no minimization
         if (.not.(tlidca.lt.dcalast1.or.tlidca.lt.dcalast2
     +        .or.tlidca.lt.dcalast3)) then
            go to 11
         else
            dcalast3 = dcalast2
            dcalast2 = dcalast1
