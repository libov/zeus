...
int main(Double_t a,Double_t b,Double_t c,Double_t d,Double_t e)
//int main()
{
	// ---------------------------- I N P U T  ------------------------- //
	...
	TF1 *fsum=new TF1("fsum",rel_breit_wigner_bg,1.036,2.7,14);
	fsum->SetLineColor(2);
	fsum->SetParName(0,"BG::Constant");
	fsum->SetParName(1,"BG::gaus peak position");
	fsum->SetParName(2,"BG::gaus width");
	...
	TF1 *fbg=new TF1("fbg",bg,1.05,2.3,14);
