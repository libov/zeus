...
int main()
{
	...
	TH1F *htemp2 = (TH1F*)f1->Get("hk0k0_2");
	// ----------------------//
	...
	htemp2->Draw();
	// -------------------------------------------------------------//
	TF1 *fsum=new TF1("fsum",rel_breit_wigner_bg,0.994,2.7,22);
	fsum->SetLineColor(2);
