...
Double_t f0(Double_t *x,Double_t *par)
{
	...
	Double_t	Gf0=par[13];
	Double_t	f0=0;
	// variable width see Flatte paper
	Gf0=par[13]*sqrt(0.25*m*m-mK0*mK0);

	// breit-wigner
	Double_t	mf0_sq=mf0*mf0;
	bw=par[14]*(mf0_sq*Gf0)/((mf0_sq-m*m)*(mf0_sq-m*m)+mf0_sq*Gf0*Gf0);
	f0=bw;
...
*/
	...
	TF1 *f0_bw=new TF1("f0_bw",f0,0.7,1.7,15);
	f0_bw->SetParameters(&par[0]);
