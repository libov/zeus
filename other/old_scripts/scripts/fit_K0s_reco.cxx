...
int main()
{
	...
	CreateCanvas();
	//c1->Divide(2,2);
	TFile *f1 =new TFile("/data/zenith226a/libov/results/K0sK0s_hist/K0s_anal_comp_true_reco2.root");
	//TFile *f1 =new TFile("/data/zenith226a/libov/results/K0sK0s_hist/K0K0_HERAI_REPRO.root");
	...
	//TFile *f1 =new TFile("/data/zenith226a/libov/results/K0sK0s_hist/temporary.root");
	...
	//TH1F *htemp = (TH1F*)f1->Get("hinv_K0s_reco");
	TH1F *htemp = (TH1F*)f1->Get("hinv_K0s_track");
	//TH1F *htemp = (TH1F*)f1->Get("h3");
	//TH1F *htemp = (TH1F*)f1->Get("h17");

	//TH1F *htemp = (TH1F*)f1->Get("h");
	//htemp->Draw();


	//TH1F *htemp = (TH1F*)f1->Get("h5");
	//TH1F *htemp = (TH1F*)f1->Get("h13");
	Float_t	histRangeLow=450,
		histRangeUp=552,
		histRange=histRangeUp-histRangeLow,
		bin_width=histRange/100;
	cout<<bin_width<<endl;
	...
	TF1 *fgaus=new TF1("fgaus","gaus",485,510);
