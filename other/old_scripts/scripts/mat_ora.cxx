...
myChain->Add("/data/zenith226a/libov/results/scripts/MCzarahMATCHING/jobs/root/*.root");
	...
	TFile *f2 =new TFile("/data/zenith226a/libov/results/scripts/MCzarahMATCHING/jobs/result.root","recreate");
	h_fmcprt->Write();
	h_f0mass->Write();
	//h_f0mass1->Write();
	h_delta_eta->Write();
