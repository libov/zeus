...
int main()
{
		...
		TFile *f1 =new TFile("/data/zenith226a/libov/results/mostrecent/K0sK0s_HERAIcos098.root");
		TH1F *htemp2 = (TH1F*)f1->Get("h1");
		TFile *f1 =new TFile("/data/zenith226a/libov/results/mostrecent/K0sK0s_HERAIIcos098.root");
		//TFile *f1 =new TFile("/data/zenith226a/libov/results/mostrecent/HERAII_2007a_noRTfit_cos098.root");
		TH1F *htemp = (TH1F*)f1->Get("h");
		htemp2->Add(h);


		/*TFile *f1 =new TFile("/data/zenith226a/libov/results/mostrecent/K0sK0s_HERAIcos098.root");
		TH1F *htemp2 = (TH1F*)f1->Get("h_eta2");
		TFile *f1 =new TFile("/data/zenith226a/libov/results/mostrecent/K0sK0s_HERAIIcos098.root");
		TH1F *htemp = (TH1F*)f1->Get("h_eta2II");
		htemp2->Add(h_eta2II);*/
