...
void anal()
{
	...
	path_main=path;
	path_main.Append(name);
	path_rest=path;
	path_rest.Append("rest");
	path_rest.Append(name);

	//-----------------------------------//
	TFile *f1 =new TFile(path_main);
...
//TFile *f2 =new
	TFile *f2 =new TFile(path_rest,"recreate");
	hsig->Write();
	...
	h_th_3->Write();
	h_th_4->Write();
	cout<<"input: "<<f1->GetName()<<endl;
	cout<<"files created:"<<endl;
	cout<<"/data/zenith226a/libov/k0eff/k0_da__00_xxxxxx.dat"<<endl;
	cout<<"/data/zenith226a/libov/k0eff/pi_da__00_xxxxxx.dat"<<endl;
