...
Double_t f0(Double_t *x,Double_t *par)
{
	...
	ph_space=par[0]*TMath::Power((1-4*(mK0/m)*(mK0/m)),par[5]);
...
//TH1F *htemp2 = (TH1F*)f1->Get("hk0k0_5_280");
	...
	//par[5]=0.5;
	par[5]=0.25/2;
	TF1 *f_fin=new TF1("f_fin",f0_bg,0.993,1.36,6);
	...
	f_fin->FixParameter(5,par[5]);
	//f_fin->SetParLimits(5,0,1);
	...
	TF1 *ff=new TF1("ff",f0,0.7,1.4,6);
	cout<<par[0]<<endl;
