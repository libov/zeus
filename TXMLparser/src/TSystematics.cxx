...
void TSystematics::Draw() {
    ...
    TString pattern = "Systematic uncertainty: ";
    if (fFlavour == kCharm || fBothFlavours) {
        char tmp[256];
        ...
        sprintf (tmp, pattern, systematic_error_charm_up, systematic_error_charm_down);
        ...
        sprintf (tmp, pattern, systematic_error_beauty_up, systematic_error_beauty_down);
