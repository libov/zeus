...
!*********************************************************************
!
! $Id: lhaglue.f 912 2012-02-29 10:17:35Z whalley $
!
! $Log$
...
!...Nuclear PDFs HKN sets 
  ...
  elseif ((lhainput .ge. 390) .and. (lhainput .le. 398)) then
     ...
     ! HERAPDF 1.0 FFNS, hack by V. Libov, libov@mail.desy.de, 21 May 2012
  elseif((lhainput .ge. 300000) .and. (lhainput .le. 300032)) then
     q2min = 1d0
     q2max = 2.0d8
     xmin = 1.0d-6
     lhaset = lhainput
     if (lhainput.eq.300000) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member0.LHgrid'
     else if (lhainput.eq.300001) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member1.LHgrid'
     else if (lhainput.eq.300002) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member2.LHgrid'
     else if (lhainput.eq.300003) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member3.LHgrid'
     else if (lhainput.eq.300004) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member4.LHgrid'
     else if (lhainput.eq.300005) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member5.LHgrid'
     else if (lhainput.eq.300006) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member6.LHgrid'
     else if (lhainput.eq.300007) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member7.LHgrid'
     else if (lhainput.eq.300008) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member8.LHgrid'
     else if (lhainput.eq.300009) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member9.LHgrid'
     else if (lhainput.eq.300010) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member10.LHgrid'
     else if (lhainput.eq.300011) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member11.LHgrid'
     else if (lhainput.eq.300012) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member12.LHgrid'
     else if (lhainput.eq.300013) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member13.LHgrid'
     else if (lhainput.eq.300014) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member14.LHgrid'
     else if (lhainput.eq.300015) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member15.LHgrid'
     else if (lhainput.eq.300016) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member16.LHgrid'
     else if (lhainput.eq.300017) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member17.LHgrid'
     else if (lhainput.eq.300018) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member18.LHgrid'
     else if (lhainput.eq.300019) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member19.LHgrid'
     else if (lhainput.eq.300020) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member20.LHgrid'
     else if (lhainput.eq.300021) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member21.LHgrid'
     else if (lhainput.eq.300022) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member22.LHgrid'
     else if (lhainput.eq.300023) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member23.LHgrid'
     else if (lhainput.eq.300024) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member24.LHgrid'
     else if (lhainput.eq.300025) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member25.LHgrid'
     else if (lhainput.eq.300026) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member26.LHgrid'
     else if (lhainput.eq.300027) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member27.LHgrid'
     else if (lhainput.eq.300028) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member28.LHgrid'
     else if (lhainput.eq.300029) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member29.LHgrid'
     else if (lhainput.eq.300030) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member30.LHgrid'
     else if (lhainput.eq.300031) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member31.LHgrid'
    else if (lhainput.eq.300032) then
        lhaname=lhapath(1:lhapathlen)//'/HERAPDF10_EIG_member32.LHgrid'
     endif
